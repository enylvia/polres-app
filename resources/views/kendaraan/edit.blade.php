...
@section('admin_content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Kendaraan Hilang</h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('update.kendaraan', $kendaraan->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT') <!-- Tambahkan ini untuk menentukan bahwa ini adalah metode PUT -->
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="no_rangka" name="no_rangka" value="{{ $kendaraan->no_rangka }}" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="nomor_polisi" name="nomor_polisi" value="{{ $kendaraan->nomor_polisi }}" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <img id="scan_bpkb_preview" src="{{ asset($kendaraan->scan_bpkb) }}" alt="Scan BPKB Preview" style="width: 150px; margin-top: 10px; display: block;">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="scan_stnk">Scan STNK:</label>
                        <input type="file" class="form-control-file" id="scan_stnk" name="scan_stnk">
                        <img id="scan_stnk_preview" src="{{ asset($kendaraan->scan_stnk) }}" alt="Scan STNK Preview" style="width: 150px; margin-top: 10px; display: block;">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <img id="foto_ktp_preview" src="{{ asset($kendaraan->foto_ktp) }}" alt="Foto KTP Preview" style="width: 150px; margin-top: 10px; display: block;">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <img id="foto_kendaraan_preview" src="{{ asset($kendaraan->foto_kendaraan) }}" alt="Foto Kendaraan Preview" style="width: 150px; margin-top: 10px; display: block;">
                    </div>
                </div>
